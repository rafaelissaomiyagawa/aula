...
public class ContaService {
  ...
  public void transfere(Integer valor, Long contaDe, Long contaPara) {
    ...
    Conta contaSaida = contaRepository.findById(contaDe).orElseThrow(EntityNotFoundException::new);

    Conta contaEntrada =
        contaRepository.findById(contaPara).orElseThrow(EntityNotFoundException::new);
