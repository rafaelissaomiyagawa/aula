...
public class CanaryTest {
    ...
    class DatabaseCanaryTests {
        ...
        void testReuseIsEnabledInPropertiesFile() {
            ...
            try (InputStream input = new FileInputStream(propertiesFilePath.toFile())) {
                ...
                Assertions.assertThat(actualValue).isEqualTo(expectedValue)
                        .withFailMessage("The property 'testcontainers.reuse.enable' should be 'true' in the properties file.");

            } catch (IOException ex) {
                Assertions.fail("Could not read the ~/.testcontainers.properties file or it does not exist: " + ex.getMessage());
            }
        }
        ...
        void postgresContainerMustBeStartable() {
            assertThatNoException()
                    .isThrownBy(TestDatabaseManager::isDbRunning);
        }
        ...
        void dropTestDB() {
            assertThatNoException()
                    .isThrownBy(TestDatabaseManager::dropTestDB);
        }
        ...
        void createTestDB() {
            assertThatNoException()
                    .isThrownBy(TestDatabaseManager::createTestDB);
        }
        ...
        void runMigration() {
            assertThatNoException()
                    .isThrownBy(TestDatabaseManager::runMigrationOnTestDB);
        }
        ...
        void createTemplate() {
            assertThatNoException()
                    .isThrownBy(TestDatabaseManager::createTemplateDBFromTestDB);
        }
    }
    ...
    class SpringCanaryTests extends BaseIntegrationTest {
        ...
        void initializeWithTestData() {
            assertThatNoException()
                    .isThrownBy(testDataInitializer::initializeDBWithDefaultProducts);
        }
        ...
        void recreateTestDB() {
            assertThatNoException()
                    .isThrownBy(TestDatabaseManager::restartTestDB);
        }
    }
}
